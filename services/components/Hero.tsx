  ...
  return (
    <section id="home" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-nature-900">
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-nature-900/90 via-nature-900/40 to-transparent" />
        <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-nature-900/60 to-transparent pointer-events-none" />
      </div>

...
$path = Join-Path $root 'jpg_za_tisk_triplo_2026\13_bogat_vrtni_substrat.jpg'
$backupDir = Join-Path $root 'backup_before_title_updates_2026-03-26\jpg_za_tisk_triplo_2026'
$backupPath = Join-Path $backupDir '13_bogat_vrtni_substrat.jpg'
...
$radius = 83.0
$titleColor = Get-AverageColor -Bitmap $bitmap -StartX 1120 -StartY 150 -Size 32
$textColor = [System.Drawing.Color]::White
$shadowColor = [System.Drawing.Color]::FromArgb(50, 0, 0, 0)
$titleText = 'ZA ZELENJAVO'
...
for ($size = 92; $size -ge 70; $size -= 1) {
  ...
  if ($measured.Width -le ($titleRect.Width - 150) -and $measured.Height -le ($titleRect.Height - 28)) {
    $font = $candidate
    break
  }
  $candidate.Dispose()
...
$tempPath = Join-Path ([System.IO.Path]::GetDirectoryName($path)) '13_bogat_vrtni_substrat.tmp.jpg'
...
Write-Host 'Updated title to ZA ZELENJAVO.'
